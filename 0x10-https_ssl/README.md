...
During this project, I gained insight into the significance of HTTPS and its operational mechanisms. I proceeded to set up HTTPS certificates using certbot and implemented HAproxy SSL termination on my HolbertonBnB web servers.
